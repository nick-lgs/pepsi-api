<?php
	...
	$wn_server = "192.168.10.23";

	$inalias_teamname = "Pepsi_Marketing";
	...
	//$invalid_login_email_template should be a filename located in /usr/etc/LGS/modules/InvalidLogin/email/
	$invalid_login_email_template = "default.html";
